...
class AllStoresTableViewController: UITableViewController {
    let url = URL(string: "https://sundaland.herokuapp.com/api/stores/all")!
            ...
            do {
                ...
                if let jsonArray = json as? [[String:Any]] {
                    ...
                    for userDictionary in jsonArray{
                        guard let name = userDictionary["name"] as? String, let city = userDictionary["city"] as? String, let country = userDictionary["country"] as? String,let province = userDictionary["province"] as? String,let postalCode = userDictionary["postalCode"] as? String,let streetAddress = userDictionary["streetAddress"] as? String else { continue }
                        
                        storeList.append(Stores(name: name,city: city, country: country,province: province, postalCode: postalCode, streetAddress: streetAddress))
